import{m as n,l as p,a as l,c as t,g as i,j as h,k as e,ak as k}from"./chunks/framework.BiaGvwvk.js";const u=JSON.parse('{"title":"关于将前端项目部署到 Linux","description":"","frontmatter":{"layout":"doc","date":"2023-09-26T00:00:00.000Z","author":"俊小赞"},"headers":[],"relativePath":"blog/nginx.md","filePath":"blog/nginx.md","lastUpdated":1766074698000}'),d={name:"blog/nginx.md"};function r(g,s,c,F,y,o){const a=p("PageInfo");return l(),t("div",null,[s[0]||(s[0]=i("h1",{id:"关于将前端项目部署到-linux",tabindex:"-1"},[h("关于将前端项目部署到 Linux "),i("a",{class:"header-anchor",href:"#关于将前端项目部署到-linux","aria-label":'Permalink to "关于将前端项目部署到 Linux"'},"​")],-1)),e(a,{readingTime:"3",wordCount:"992",publicTime:""}),s[1]||(s[1]=k(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>本文主要从零开始，记录如何将前端项目部署到 Linux 服务器，比较基础。希望能帮助到你们。</p><h2 id="技术栈" tabindex="-1">技术栈 <a class="header-anchor" href="#技术栈" aria-label="Permalink to &quot;技术栈&quot;">​</a></h2><p>操作系统：Linux ubuntu</p><p>服务器：Nginx 一款轻量级的 Web 服务器、反向代理服务器</p><p>前端项目：Vue3</p><p>操作软件：Tabby 一个高度可配置的现代化终端模拟器</p><h2 id="基础命令" tabindex="-1">基础命令 <a class="header-anchor" href="#基础命令" aria-label="Permalink to &quot;基础命令&quot;">​</a></h2><p>由于是第一次接触 linux 系统，所以我们先熟悉一下 linux 基础的命令。</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## 1.列出目录中的文件和子目录</span></span>

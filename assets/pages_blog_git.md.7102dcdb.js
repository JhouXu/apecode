import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.76cdd7a0.js";const A=JSON.parse('{"title":"常用的 git 命令总结","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"pages/blog/git.md","lastUpdated":1696833552000}'),p={name:"pages/blog/git.md"},o=l(`<h1 id="常用的-git-命令总结" tabindex="-1">常用的 git 命令总结 <a class="header-anchor" href="#常用的-git-命令总结" aria-label="Permalink to &quot;常用的 git 命令总结&quot;">​</a></h1><h2 id="一、仓库" tabindex="-1">一、仓库 <a class="header-anchor" href="#一、仓库" aria-label="Permalink to &quot;一、仓库&quot;">​</a></h2><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;"># </span><span style="color:#FFCB6B;">在当前目录新建一个 Git 代码库</span></span>

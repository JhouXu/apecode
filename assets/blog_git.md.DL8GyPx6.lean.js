import{_ as i,c as a,a7 as n,o as l}from"./chunks/framework.BnEylvxT.js";const d=JSON.parse('{"title":"常用的 git 命令总结","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"blog/git.md","filePath":"blog/git.md","lastUpdated":1727421978000}'),h={name:"blog/git.md"};function p(k,s,t,e,F,g){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="常用的-git-命令总结" tabindex="-1">常用的 git 命令总结 <a class="header-anchor" href="#常用的-git-命令总结" aria-label="Permalink to &quot;常用的 git 命令总结&quot;">​</a></h1><h2 id="一、仓库" tabindex="-1">一、仓库 <a class="header-anchor" href="#一、仓库" aria-label="Permalink to &quot;一、仓库&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在当前目录新建一个 Git 代码库</span></span>

...
<span class="line"><span>sudo nano /etc/nginx/sites-available/default</span></span></code></pre></div><p>打开，应该看到这样的结构。需要做： 1. 设置根路径；2. 修改 try_files</p><div class="language-dash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>server {</span></span>

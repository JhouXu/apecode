import{m as i,l as p,c as l,b as e,g as a,k as t,ak as h,j as k}from"./chunks/framework.D9cF0xwY.js";const q=JSON.parse('{"title":"环境变量使用指南","description":"","frontmatter":{},"headers":[],"relativePath":"blog/plugin/vue-env-variables.md","filePath":"blog/plugin/vue-env-variables.md","lastUpdated":1740577775000}'),o={name:"blog/plugin/vue-env-variables.md"};function c(d,s,r,u,E,g){const n=p("PageInfo");return e(),l("div",null,[s[0]||(s[0]=a("h1",{id:"环境变量使用指南",tabindex:"-1"},[k("环境变量使用指南 "),a("a",{class:"header-anchor",href:"#环境变量使用指南","aria-label":'Permalink to "环境变量使用指南"'},"​")],-1)),t(n,{readingTime:"2",wordCount:"520",publicTime:"2025-02-26"}),s[1]||(s[1]=h(`<p>在 <code>vue cli</code> 和 <code>vue vite</code> 中，存在一个叫做环境变量的概念。它可以根据 <code>.env</code> 配置文件中的变量，自主选择匹配当前环境的配置。<code>使用场景：开发环境使用 /dev-api ，而生产环境使用 /prod-api</code>。</p><p>本文将分别介绍在 vue cli 和 vue vite 中如何使用环境变量。</p><h2 id="vue-cli" tabindex="-1">vue cli <a class="header-anchor" href="#vue-cli" aria-label="Permalink to &quot;vue cli&quot;">​</a></h2><p><code>vue2 + webpack</code></p><p>分别定义开发环境和生产环境的变量。</p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>请注意，只有 <code>NODE ENV</code>，<code>BASE_URL</code> 和以 <code>VUE_APP</code> 开头的变量将通过 <code>webpack.DefinePlugin</code> 静态地嵌入到客户端侧的代码中。这是为了避免意外公开机器上可能具有相同名称的私钥。</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># vue-cli/.env.development</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;PageInfo readingTime=&quot;2&quot; wordCount=&quot;520&quot; publicTime=&quot;2025-02-26&quot;/&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>

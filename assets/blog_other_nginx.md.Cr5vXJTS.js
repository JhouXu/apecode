import{m as n,l as p,c as l,b as t,g as i,k as h,ak as e,j as k}from"./chunks/framework.D9cF0xwY.js";const m=JSON.parse('{"title":"关于将前端项目部署到 Linux","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"blog/other/nginx.md","filePath":"blog/other/nginx.md","lastUpdated":1737041243000}'),d={name:"blog/other/nginx.md"};function r(g,s,c,F,y,o){const a=p("PageInfo");return t(),l("div",null,[s[0]||(s[0]=i("h1",{id:"关于将前端项目部署到-linux",tabindex:"-1"},[k("关于将前端项目部署到 Linux "),i("a",{class:"header-anchor",href:"#关于将前端项目部署到-linux","aria-label":'Permalink to "关于将前端项目部署到 Linux"'},"​")],-1)),h(a,{readingTime:"7",wordCount:"1.8k"}),s[1]||(s[1]=e(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>本文主要从零开始，记录如何将前端项目部署到 Linux 服务器，比较基础。希望能帮助到你们。</p><h2 id="技术栈" tabindex="-1">技术栈 <a class="header-anchor" href="#技术栈" aria-label="Permalink to &quot;技术栈&quot;">​</a></h2><p>操作系统：Linux ubuntu</p><p>服务器：Nginx 一款轻量级的 Web 服务器、反向代理服务器</p><p>前端项目：Vue3</p><p>操作软件：Tabby 一个高度可配置的现代化终端模拟器</p><h2 id="基础命令" tabindex="-1">基础命令 <a class="header-anchor" href="#基础命令" aria-label="Permalink to &quot;基础命令&quot;">​</a></h2><p>由于是第一次接触 linux 系统，所以我们先熟悉一下 linux 基础的命令。</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## 1.列出目录中的文件和子目录</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [命令]</span></span></code></pre></div><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## 首先，更新系统的软件包列表，确保获取最新的可用软件包信息。</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">nginx</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -v</span></span></code></pre></div><p>之前已经安装过，第一次安装命令执行会不一样，所以最后需要执行一下 nginx -v，确保已经安装上 nginx</p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f84a46210ad24bdca6080428ca5eb901~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=664&amp;h=343&amp;s=44196&amp;e=png&amp;b=212a35" alt="image.png"><p>安装成功之后，直接使用服务器 ip 的方式，在浏览器地址栏中输入，应该能够访问到 nginx 的初始页面（需要启动 <code>sudo systemctl start nginx</code>），如下图：</p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e71684071a67418b9f4cd4856f21d5a6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1090&amp;h=743&amp;s=186550&amp;e=png&amp;b=ffffff" alt="image.png"><p><code>nginx 相关命令</code></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## 1. 启动 Nginx</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> nginx</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -V</span></span></code></pre></div><h2 id="上传处理" tabindex="-1">上传处理 <a class="header-anchor" href="#上传处理" aria-label="Permalink to &quot;上传处理&quot;">​</a></h2><h3 id="上传" tabindex="-1">上传 <a class="header-anchor" href="#上传" aria-label="Permalink to &quot;上传&quot;">​</a></h3><p>将打包好的 vue 项目，即 dist 目录文件上传到服务器中，其中 Tabby 一次只能上传一个文件或者是一个压缩文件夹，为此需要提前将 dist 进行压缩。</p><p>然后，Tabby 打开你想要上传到的文件路径中，演示使用路径 <code>/home/ubuntu/files/</code>。长按拖拽至即可上传。</p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7a19399281a648098ed6546d8db6a5cd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=844&amp;h=611&amp;s=44075&amp;e=png&amp;b=0d1219" alt="image.png"><h3 id="解压" tabindex="-1">解压 <a class="header-anchor" href="#解压" aria-label="Permalink to &quot;解压&quot;">​</a></h3><p>上传的时候，使用的 .zip 的压缩文件类型，需要在 linux 上进行一次解压操作。</p><p>解压需要使用 unzip 软件，安装如下：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> apt</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> update</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    ## 更新软件列表</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> apt</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> unzip</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    ## 安装 unzip</span></span></code></pre></div><p>安装完成后，即可使用 unzip 相关命令：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">unzip</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [options] filename.zip</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">unzip</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> example.zip</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /path/to/directory</span></span></code></pre></div><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/790e355ed7314d9887508e57fae67bcd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=754&amp;h=224&amp;s=30186&amp;e=png&amp;b=212a35" alt="image.png"><p>这里我将上传的 dist.zip 解压，且解压至 <code>var/www/html/</code> 下，因为这个路径是， nginx 的初始路径（下图为解压后）。</p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/49a9ca5907d04ff091a0722cd5d63f90~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=844&amp;h=410&amp;s=36601&amp;e=png&amp;b=131b24" alt="image.png"><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h2><p>完成上面的步骤之后，因为 nginx 的默认启动路径是 <code>/var/www/html/index.nginx-debian.html</code>，所以需要将这个启动路径重新指向到 <code>/var/www/html/dist/index.html</code> 中，修改方式如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>## 使用 nano 编辑器，打开 /etc/nginx/sites-available/default 文件</span></span>
<span class="line"><span>sudo nano /etc/nginx/sites-available/default</span></span></code></pre></div><p>打开，应该看到这样的结构。需要做： 1. 设置根路径；2. 修改 try_files</p><div class="language-dash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    listen 80 default_server;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    listen [::]:80 default_server;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    root /var/www/html/dist;    ## 1. 设置根路径</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    location / {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        ## First attempt to serve request as file, then</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        ## as directory, then fall back to displaying a 404.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        ## try_files $uri $uri/ =404;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        try_files $uri $uri/ /dist/index.html;    ## 2. 修改 try_files</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>nano 编辑器快捷键：保存：ctrl + S，退出：ctrl + Z.</p><p>配置完成后，别忘了重启 Nginx 服务（<code>sudo systemctl restart nginx</code>）</p><p>到此，就已经完成了将前端项目部署到 Linux 的全部过程，有别的方案欢迎在评论区留下你的见解。</p><hr><h2 id="gzip" tabindex="-1">GZIP <a class="header-anchor" href="#gzip" aria-label="Permalink to &quot;GZIP&quot;">​</a></h2><p>如果还没看<code>上传处理</code>和<code>配置</code>部分的内容，推荐看了再来。</p><p>gzip 是一种数据压缩算法，可以将文本文件等内容进行压缩，减小文件大小，提高传输效率。正好 nginx 有相关配置。</p><p>需要打开 nginx.conf 文件，命令 <code>sudo nano /etc/nginx/nginx/conf</code></p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/96737c15a9fe473388f0e8785623fb95~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1920&amp;h=955&amp;s=84218&amp;e=png&amp;b=212a35" alt="image.png"><p>找到 Gzip Settings，默认情况下，这里的内容是被注释起来的，解除注释，且对比少了的配置，添加进去即可。保存之后，需要重启一下 nginx.</p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/03aa4aa3251c4416834274b305c283ae~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1325&amp;h=381&amp;s=29548&amp;e=png&amp;b=212a35" alt="image.png"><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## 配置参数</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">gzip_types</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> *</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><p>验证是否成功开启 gzip 的方式，可以打开浏览器控制台，查看网络面板的资源加载情况。</p><p>Content-Encoding: gzip (即开启 GZIP)</p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ed41c9eedd9f4b1ba22bc15f501b5436~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1338&amp;h=582&amp;s=75574&amp;e=png&amp;b=292929" alt="image.png">`,52))])}const u=n(d,[["render",r]]);export{m as __pageData,u as default};

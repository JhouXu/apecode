export const BlogData = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "CSS Grid 网格布局", link: "/blog/css-grid.md", time: "2021-07-13" },
    ...
    items: [
      {
        ...
        link: "/blog/example-html2canvas.md",
        time: "2021-02-07",
      },
      ...
      { text: "日期倒计时计算 countdown", link: "/blog/example-get-countdown.md", time: "2021-10-17" },
      {
        ...
        link: "/blog/example-ios-touch.md",
        time: "2022-03-25",
      },
      { text: "如何在 vite 动态设置打包目录", link: "/blog/vite-build-dynamic.md", time: "2024-11-12" },
      { text: "环境变量使用指南", link: "/blog/vue-env-variables.md", time: "2025-02-26" },
      { text: "Github Connection Refused", link: "/blog/github-connection-refused.md", time: "2025-04-21" },
    ],
  },
  {
    text: "🔌 插件扩展",
  ...
  },
  {
    ...
    items: [
      ...
      { text: "表格开发常见的渲染方式", link: "/blog/table-render.md", time: "2025-01-23" },
      { text: "TypeScript 学习笔记", link: "/blog/typescript.md", time: "2025-02-20" },
      { text: "设计模式", link: "/blog/design-patterns.md", time: "2025-04-07" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "开源许可的全面指南", link: "/blog/licenses.md", time: "2025-01-16" },
      { text: "客户端中的几种存储机制", link: "/blog/client-storage.md", time: "2025-02-07" },
      { text: "DeepSeek 本地部署", link: "/blog/deep-seek-local-deploy.md", time: "2025-03-14" },
      { text: "Review 2025", link: "/blog/review-2025.md", time: "2025-05-09" },
    ],
  },
];

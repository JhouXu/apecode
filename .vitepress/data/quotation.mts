...
export const quotationData: Item[] = [
  ...
  {
    content: "我从未想到会被公司解雇，因为我的表现总是高于公司的期望。后来我想明白了。在裁员期间，你是谁、你做什么似乎并不重要，在大多情况下，裁员的决定是由那些不认识你的人做出的。对于公司来说，我只是 Excel 表格中的一行。",
    source: "【裁员改变了我】",
    date: "2025-02-07",
  },
  {
  ...
  {
    content: "你写博客是因为你在思考，因为你在观察，因为你希望把它放在某个地方。如果有人读了，那就更好了。如果没有，工作还是完成了。",

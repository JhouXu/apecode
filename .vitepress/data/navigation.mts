...
export const TechnicalCommunity: navigationItem[] = [
  ...
  {
    text: "Css Tricks",
    desc: "A Website About Making Websites - 一个关于制作网站的网站",
    link: "https://css-tricks.com/",
    icon: "https://css-tricks.com/apple-touch-icon.png",
    type: "技术社区",
  },
  {
    text: "Css Tricks - A Guide to SVG Animations (SMIL)",
    desc: "SVG动画指南（SMIL）",
...
export const TechnologyStack: navigationItem[] = [
  {
    text: "JQuery",
    desc: "一个快速、小巧且功能丰富的 JavaScript 库。",
  ...
  {
    text: "Bootstrap",
    desc: "最流行的 HTML、CSS 和 JavaScript 框架，用于开发响应式布局、移动优先的 WEB 项目。",
  ...
  {
    text: "TypeScript",
    desc: "JavaScript 的超集，为 JavaScript 添加了类型系统",
  ...
  {
    text: "TailwindCSS",
    desc: "一个用于快速构建自定义用户界面的实用工具优先的 CSS 框架",
  ...
  {
    text: "Sass",
    desc: "Sass 是一种 CSS 预处理器，它允许你使用变量、嵌套规则、混合（Mixins）、函数等来编写更简洁、更易于维护的 CSS 代码。",
  ...
  {
    text: "Less",
    desc: "Less 是一种 CSS 预处理器，它允许你使用变量、嵌套规则、混合（Mixins）、函数等来编写更简洁、更易于维护的 CSS 代码。",
  ...
  {
    text: "PixiJS",
    desc: "一个轻量级的2D渲染引擎，用于创建高性能的交互式图形。",
  ...
  {
    text: "GsapJS",
    desc: "GSAP 是一个 JavaScript 动画库，用于创建高性能、跨浏览器的动画。",
  ...
  {
    text: "SwiperJS",
    desc: "Swiper 是一款免费开源的移动端触摸滑动库，适用于移动端、PC 端、Web 端。",
    link: "https://swiperjs.com/",
    icon: "https://swiperjs.com/images/favicon.svg",
    type: "技术栈",
  },
  {
    text: "AnimateCSS",
    desc: "一个轻量级的 CSS 动画库，用于创建各种动画效果。",
  ...
  {
    text: "ScrollRevealJS",
    desc: "输入/离开视口时轻松地为其动画元素。",
    link: "https://scrollrevealjs.org/",
    icon: "https://scrollrevealjs.org/favicon.ico",
    type: "技术栈",
  },
  {
    text: "WoWJS",
    desc: "一个用于创建滚动动画的 JavaScript 库。",
    link: "https://wowjs.uk/",
  ...
  {
    text: "CreateJS",
    desc: "一套模块化库和工具，它们可以通过HTML5在开放的Web技术上启用丰富的交互式内容。",
    link: "https://createjs.com/",
    icon: "https://createjs.com/assets/favicons/apple-touch-icon-114x114.png",
    type: "技术栈",
  },
  {
    text: "MomentJS",
    desc: "一个用于解析、验证、操作和显示日期和时间的 JavaScript 库。",
  ...
  {
    text: "DayJS",
    desc: "一个轻量级的 JavaScript 日期库，用于解析、验证、操作和显示日期和时间。",
...
export const OnlineTools: navigationItem[] = [
  ...
  {
    text: "RAP接口管理平台",
    desc: "RAP是一个可视化接口管理工具，由阿里妈妈MUX团队出品，旨在提高团队协作效率。",
  ...
  },
  {
    ...
    link: "https://jsbin.com/?html,css,js,console,output",
    icon: "https://static.jsbin.com/images/favicon.png",
    type: "在线工具",
  },
  {
    text: "SMS",
    desc: "虚拟电话号码 - 接收短信和呼叫虚拟号码以注册任何服务和应用程序的帐户，以获得利润和折扣",
    link: "https://sms-activate.guru",
    icon: "https://smsactivate.s3.eu-central-1.amazonaws.com/assets/img/logoMeta.png",
    type: "在线工具",
  },
  {
    text: "HYPERBEAM",
    desc: "Browse the web and watch together online - 浏览 Web 并在线一起观看",
    link: "https://watch.hyperbeam.com/",
    icon: "https://watch.hyperbeam.com/favicon.png",
    type: "在线工具",
  },
  {
    text: "BrowserStack",
    desc: "App & Browser Testing Made Easy - 应用程序和浏览器测试变得简单",
...
export const SoftwareClient: navigationItem[] = [
  ...
  {
    text: "blender",
    desc: "Blender's comprehensive array of modeling tools make creating, transforming and editing your models a breeze.",
...
export const MaterialResources: navigationItem[] = [
  ...
  {
    text: "IconPark",
    desc: "技术驱动图标样式的开源图标库，字节开源",
    link: "https://iconpark.oceanengine.com/",
    icon: "https://lf1-cdn2-tos.bytegoofy.com/bydesign/iconparksite/logo192.png",
    type: IconSource,
  },
  {
    text: "FontAwesome",
  ...
  {
    text: "Themify Icons",
    desc: "一套用于网页设计和应用程序的完整图标",
    link: "https://themify.me/themify-icons",
    icon: "https://themify.me/wp-content/uploads/2024/11/themify-avatar.png",
    type: IconSource,
  },

...
enum SourceType {
  IconSource = "图标素材",
  IllustrationSource = "插画素材",
  FontSource = "字体素材",
  ImgSource = "图像素材",
  VideoSource = "视频素材",
  ImgVideoSource = "图像视频素材",
  AudioSource = "音频素材",
  TemplatePlugin = "模板插件",
}
...
export const TechnicalCommunity: navigationItem[] = [
  {
    ...
    type: NavigationType.TechnicalCommunity,
  },
  {
    text: "hellogithub",
    desc: "有趣的开源社区",
...
export const OnlineDocument: navigationItem[] = [
  {
    ...
    type: NavigationType.OnlineDocument,
  },
  {
...
export const TechnologyStack: navigationItem[] = [
  {
    ...
    type: NavigationType.TechnologyStack,
  },
  {
    text: "Bootstrap",
...
export const OnlineTools: navigationItem[] = [
  {
    ...
    type: NavigationType.OnlineTools,
  },
  {
    text: "StrApi",
...
export const DesignRelated: navigationItem[] = [
  {
    ...
    type: DesignType.ColorReference,
  },
  {
    text: "调色板",
    desc: "平面UI颜色",
...

  {
    ...
    type: DesignType.DesignReference,
  },
...
export const MaterialResources: navigationItem[] = [
...

  {
    ...
    type: SourceType.IllustrationSource,
  },
  {
    text: "iradesign",
...

  {
    ...
    type: SourceType.ImgVideoSource,
  },
  {
    text: "Pexels",
...

  {
    ...
    type: SourceType.TemplatePlugin,
  },
  {
    text: "大众脸",
    desc: "",

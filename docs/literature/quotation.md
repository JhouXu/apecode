...
<script lang="ts" setup>
  ...
  const quotationData: Item[] = [
    ...
    {
      content: "如果你兜里有 86400 块，不小心掉了 400 块，你会气得把剩下的 86000 块也都丢进垃圾桶吗，你肯定会说你有病吧，谁会干这么傻的事，没错谁都不会这么做，可你有没有想过，我们的每一天有 86000 秒，为什么要因为那 400 秒的不开心，毁掉剩下的 86000 秒呢，钱丢了可以再挣，心情丢了这一天就真的亏了。",
      source: "小红书 情绪研究员",
      date: "2026-01-31",
    },
    {
      content: "每一次科技的重大变化，和每一次政策的重大变化，都是一次财富重新分配的机会，有变化就一定会有需求，而你却能够满足变化所带来的需求，就是你未来挣钱的道。一定要想办法迎合变化，而不是惧怕变化。",
      source: "张雪峰",
      date: "2026-03-27",
    }
  ];

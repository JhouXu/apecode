...
export const blog = [
  { text: "微信小程序之数据通讯", link: "/blog/program-datacom", type: `${program}`, time: "2023-06-14" },
  ...
  { text: "Prettier 一个固执的代码格式化程序", link: "/blog/plugin-prettier", type: `${other}`, time: "2021-07-17" },
  { text: "ESLint 语法检验工具的使用", link: "/blog/plugin-eslint", type: `${other}`, time: "2021-07-17" },
